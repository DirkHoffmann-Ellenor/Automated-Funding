...
export default function ScrapeForm() {
  ...
  // TODO: Surface a visible status/log stream so users can monitor scrape progress in real time.
    ...
    <div className="space-y-10">
      <section className="rounded-2xl bg-white p-6 shadow">
        ...
        <p className="text-sm text-slate-500">
          Runs immediate scrape + LLM extraction.
        </p>
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Example Community Grants"
            />
          </div>
        </div>
        <button
            ...
            <div className="mt-2 grid gap-3 md:grid-cols-2">
              <div>
                ...
                <p className="text-base font-medium">
                  {singleResult.eligibility || "Unknown"}
                </p>
              </div>
              <div>
      ...
      <section className="rounded-2xl bg-white p-6 shadow">
        ...
        <p className="text-sm text-slate-500">
          Queue multiple URLs. Progress updates every few seconds.
        </p>
        <textarea
        ...
        <div className="mt-3 flex items-center justify-between text-sm text-slate-500">
          ...
          <button
            ...
            disabled={bulkUrls.length === 0 || isSubmitting}
          >
